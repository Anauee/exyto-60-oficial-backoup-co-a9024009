        ...
        <form onSubmit={handleSubmit} className="p-8 pt-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[100px] bg-background/50 border-border/40 rounded-2xl p-4 focus:ring-primary/20 transition-all resize-none"
            />
          </div>
            ...
            {formData.imagem ? (
              ...
              <label className="flex flex-col items-center justify-center w-full aspect-video border-2 border-dashed border-border/60 rounded-[2rem] bg-muted/20 hover:bg-muted/40 hover:border-primary/40 cursor-pointer transition-all group overflow-hidden relative">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="text-sm font-black tracking-tight text-foreground">Clique para enviar</p>
                  <p className="text-xs text-muted-foreground font-medium">PNG, JPG ou GIF</p>
                </div>
                <input 
                  type="file" 
                  className="hidden" 
